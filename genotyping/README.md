...
* To check the quality of imputing missing genotypes caused by merging the three platforms, we randomly set a proportion (10%, 20%, 30%, 40%, 50%, and 60%) of the genotypes as missing, and used the BEAGLE software to impute the genotypes and check how many of the missing genotypes can be correctly imputed back. The WGS refined genotypes (chr1 only) were used. 

Missing rate | #genotypes set as missing | #genotypes correctly imputed | Rate of correct imputation
:---: | :---: | :---: | :---:
0.1 | 27656300 | 27328744 | 0.988
0.2 | 56300325 | 55593449 | 0.987
0.3 | 83956625 | 82811611 | 0.986
0.4 | 112600650 | 110852985 | 0.984
0.5 | 140256950 | 137511394 | 0.98
0.6 | 168900975 | 162894716 | 0.964
